...
//		"<ul class='pagination pagination-sm' class='pull-left'> " +
//		"<li><a href='#'>首页</a></li> " +
//		"<li><a href='#'>上一页</a></li> " +
//		" <li><a href='#'>下一页</a></li> " +
//		"<li><a href='#'>尾页</a></li> " +
//		"</ul> " +
//		"<div class='input-go-page'> " +
//		"<div class='input-page clearfix'> " +
//		"<div class='input-group input-group-sm'> " +
//		" <span class='input-group-addon'>页数:</span> " +
//		" <input type='text' class='form-control' id='input-page'> " +
//		"   </div> " +
//		"</div> " +
//		" <span class='whole-page'> " +
//		"      共<span id ='totalSpan'></span>页，<span id ='recordSpan'></span>" +
//		" </span> " +
//		"   <button class='btn btn-primary btn-sm go-page pull-right' id='turnto' type='button'>转到</button> " +
//		"  </div>    " + 
//		
//		"</div> " ;
...
//	var self = this;
//
//	var span = div.firstChild.childNodes[1];
//	span = span.childNodes[1];
//	span.onclick = function () { self.firstPage(); }
//	
//	span = div.firstChild.childNodes[1].childNodes[3];
//	span.onclick = function () { self.pageUp(); }
//	
//	span = div.firstChild.childNodes[1].childNodes[5];
//	span.onclick = function () { self.pageDown(); }
//	
//	span = div.firstChild.childNodes[1].childNodes[7];
//	span.onclick = function () { self.lastPage(); }
//
//
//	
//	this.pageInput = $$("input-page");
//	this.totalSpan = $$("totalSpan");
//	this.recordsSpan = $$("recordSpan");
//
//	return;
}
...
/** 将文本显示为指定长度 */
TableList.prototype.text = function(content, maxLength)
{
...
//		text.style.margin = "5px";
		...
		if(o.icon == ''){
			...
			text.innerHTML = '<img src="' + o.icon+ '" title="'+ o.text +'" style="padding-left:2px;padding-right:2px;"/>';
		}
...
TableList.link1 = function(operations, object)
{
	...
	for (var i = 0; i < operations.length; i++)
	{
		...
		span1.style.cssText="padding-left:4px";
		btn.setAttribute("class", "btn btn-na");

		btn.innerHTML=o.name;
		btn.object = object;
		btn.action = o.onclick;
		btn.onclick = function () { this.action(this.object); };
	}

	return div1;
}

TableList.link2 = function(checks, object)
{
	var div2 = document.createElement("div");
	var check = document.createElement("input");
    check.setAttribute("type", "checkbox");
	div2.appendChild(check);
	check.setAttribute("value",object.id);
	return div2;
}
