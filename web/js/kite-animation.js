...
jQuery(document).ready(function($) {
    ...
    $('.kite-path').transition({width: '730px', delay: 500}, 3000, 'linear');
    $('.kite').transition({opacity: 1, x: 100, y: -50, delay: 300, rotate: '50deg'}, 300, 'linear')
            ...
            .transition({x: 550, y: -100, rotate: '60deg'}, 250, 'linear')
            .transition({x: 620, y: -70, rotate: '25deg'}, 300, 'linear')
            .transition({x: 770, y: -180, rotate: '10deg'}, 600, 'linear');
