...
public class 添加会议负责人信息  extends AbstractOperation implements Operation{
	private HotelMiceIncharger hotelMiceIncharger; 
	...
	public void execute() throws Exception {
		...
		hoteldao.addHotelMiceIncharger(hotelId, hotelMiceIncharger);
	}

	public HotelMiceIncharger getHotelMiceIncharger() {
		return hotelMiceIncharger;
	}

	public void setHotelMiceIncharger(HotelMiceIncharger hotelMiceIncharger) {
		this.hotelMiceIncharger = hotelMiceIncharger;
	}
