...
import com.quiven.util.JavaPackageExplorer;
...
public abstract class OperationManager
{
	...
	/** 所有可用操作实现类 */
	protected Map<String, Class<? extends Operation>> operations = new ConcurrentHashMap<String, Class<? extends Operation>>();
	...
	/** 获取指定帐户执行指定操作的角色集合 */
//	public abstract Set<Role> getAccountOperationRoles(Account account, String operation) throws Exception;
	
	/** 获取指定帐户执行指定 */
	public abstract Set<Long> getAccountOperationDepartmentIds(Account account, String name) throws Exception;

	public abstract Set<Long> getAccountOperationDepartmentIdsForManageTree(Account account, String name) throws Exception;
	/** 载入权限 */
	public abstract void loadPrivileges() throws Exception;
	
	/** 
	 * 刷新权限系统
	 * @param flag 修改权限系统后是否延时刷新，false则延时刷新
	 * */
	public abstract void refresh(boolean flag);
}
